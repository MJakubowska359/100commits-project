...
export class FooterPage {
    ...
    employerPanelBtn = this.page.getByRole('button', {
        name: 'Employer Panel',
    });
    candidateProfileBtn = this.page.getByRole('button', {
    ...
    privacyPolicyBtn = this.page.getByRole('button', {
        name: 'Privacy Policy',
    });
    cookieSettingsBtn = this.page.getByRole('button', {
